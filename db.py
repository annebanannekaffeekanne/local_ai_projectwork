...
def index_documents(docs):
    for doc in docs:
        ...
        print("docs in collection:", len(collection.get()['documents']))
    print(f"total docs in collection: {len(collection.get()['documents'])}")
    return
...
def update_docs(docs):
    ...
    print(f"docs to update: {len(to_update)}")
